    ...
    public static class ItemSorter implements Comparator<Slot> {
        ...
        public int compare(final Slot arg0, final Slot arg1) {
            if (!arg0.getHasStack()) {
                ...
                final String i1 = this.concat(arg0.getStack().getTooltip(Minecraft.getMinecraft().thePlayer, true));
                final String i2 = this.concat(arg1.getStack().getTooltip(Minecraft.getMinecraft().thePlayer, true));
