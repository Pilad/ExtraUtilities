...
public class RecipeMagicalWood extends ShapedRecipes {
    ...
    public RecipeMagicalWood() {
        super(3, 3, new ItemStack[]{RecipeMagicalWood.gold, RecipeMagicalWood.book, RecipeMagicalWood.gold, RecipeMagicalWood.book, RecipeMagicalWood.bookshelf, RecipeMagicalWood.book, RecipeMagicalWood.gold, RecipeMagicalWood.book, RecipeMagicalWood.gold}, new ItemStack(ExtraUtils.decorative1, 1, 8));
    }
