...
public class TileEntityTransferNodeInventory extends TileEntityTransferNode implements INodeInventory, ISidedInventory {
            ...
            if (inv instanceof ISidedInventory) {
                ...
                for (int i = 0; i < aint.length && (this.buffer.getBuffer() == null || ((ItemStack) this.buffer.getBuffer()).stackSize < ((ItemStack) this.buffer.getBuffer()).getMaxStackSize()); ++i) {
                    ...
                    if (itemstack != null && itemstack.stackSize > 0 && (this.buffer.getBuffer() == null || XUHelper.canItemsStack((ItemStack) this.buffer.getBuffer(), itemstack, false, true)) && invs.canExtractItem(aint[i], itemstack, dir)) {
                        ...
                        if (this.upgradeNo(3) == 0) {
                            itemstack3 = XUHelper.invInsert(this, invs.decrStackSize(aint[i], 1), -1);
                        } else {
                            itemstack3 = XUHelper.invInsert(this, invs.getStackInSlot(aint[i]), -1);
                        }
                        if (this.upgradeNo(3) == 0) {
                            if (itemstack3 == null) {
                                inv.markDirty();
                ...
                for (int j = inv.getSizeInventory(), k = 0; k < j && (this.buffer.getBuffer() == null || ((ItemStack) this.buffer.getBuffer()).stackSize < ((ItemStack) this.buffer.getBuffer()).getMaxStackSize()); ++k) {
                    ...
                    if (itemstack4 != null && (this.buffer.getBuffer() == null || XUHelper.canItemsStack((ItemStack) this.buffer.getBuffer(), itemstack4, false, true))) {
                        ...
                        if (this.upgradeNo(3) == 0) {
                            itemstack6 = XUHelper.invInsert(this, inv.decrStackSize(k, 1), -1);
                        } else {
                            itemstack6 = XUHelper.invInsert(this, inv.getStackInSlot(k), -1);
                        }
    ...
    private void suckItems() {
        if (this.buffer.getBuffer() == null || ((ItemStack) this.buffer.getBuffer()).stackSize < ((ItemStack) this.buffer.getBuffer()).getMaxStackSize()) {
            ...
            for (final Object o : this.worldObj.getEntitiesWithinAABB(EntityItem.class, AxisAlignedBB.getBoundingBox(this.xCoord, this.yCoord, this.zCoord, this.xCoord + 1, this.yCoord + 1, this.zCoord + 1).offset(dir.offsetX * (1.0 + r), dir.offsetY * (1.0 + r), dir.offsetZ * (1.0 + r)).expand(r, r, r))) {
                ...
                if (item.isEntityAlive() && itemstack != null && (this.buffer.getBuffer() == null || XUHelper.canItemsStack((ItemStack) this.buffer.getBuffer(), itemstack, false, true))) {
                    ...
                    itemstack2 = XUHelper.invInsert(this, itemstack2, -1);
                    if (itemstack2 != null) {
    ...
    private boolean doCraft() {
        if (this.buffer.getBuffer() == null || ((ItemStack) this.buffer.getBuffer()).stackSize < ((ItemStack) this.buffer.getBuffer()).getMaxStackSize()) {
                ...
                for (int dy = -1; dy <= 1; ++dy) {
                    ...
                    if (b) {
                        ...
                        if (i >= 0) {
                            ...
                            TileEntityTransferNodeInventory.crafting.setInventorySlotContents(j, null);
                        }
                    } else {
                        inventories[j] = null;
                        TileEntityTransferNodeInventory.crafting.setInventorySlotContents(j, null);
            ...
            if (this.cachedRecipe == null || !this.cachedRecipe.matches(TileEntityTransferNodeInventory.crafting, this.worldObj) || this.cachedRecipe.getCraftingResult(TileEntityTransferNodeInventory.crafting) == null) {
                ...
                if (r == null || r.getCraftingResult(TileEntityTransferNodeInventory.crafting) == null || !this.isItemValidForSlot(0, r.getCraftingResult(TileEntityTransferNodeInventory.crafting))) {
                    return true;
                }
                this.cachedRecipe = r;
            }
            final ItemStack stack = this.cachedRecipe.getCraftingResult(TileEntityTransferNodeInventory.crafting);
            this.prevStack = 0;
