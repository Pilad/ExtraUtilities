...
public abstract class TileEntityTransferNode extends TileEntity implements IPipe, INode, IPipeCosmetic, IChunkLoad {
    ...
    public boolean handleInventories() {
        ...
        if (ss) {
            final IPipe pipe = TNHelper.getPipe(this.worldObj, this.xCoord + this.pipe_x, this.yCoord + this.pipe_y, this.zCoord + this.pipe_z);
            if (pipe == null) {
                this.resetSearch();
                return false;
            }
    ...
    public boolean advPipeSearch() {
        ...
        if (pipeBlock != null) {
            ...
            final ArrayList<ForgeDirection> dirs = pipeBlock.getOutputDirections(this.worldObj, this.xCoord + this.pipe_x, this.yCoord + this.pipe_y, this.zCoord + this.pipe_z, ForgeDirection.getOrientation(this.pipe_dir), this.buffer);
