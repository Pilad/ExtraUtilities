...
public class BlockGenerator extends BlockMultiBlock implements IMultiBoxBlock, IBlockTooltip {
    ...
    public static void addUpgradeRecipes(final Block a, final Block b) {
        for (int i = 0; i < BlockGenerator.num_gens; ++i) {
            GameRegistry.addRecipe(new ItemStack(b, 1, i), "SSS", "SES", "SSS", 'S', new ItemStack(a, 1, i), 'E', ExtraUtils.transferNodeEnabled ? new ItemStack(ExtraUtils.transferNode, 1, 12) : Blocks.redstone_block);
        }
    }

    public static void addSuperUpgradeRecipes(final Block a, final Block b) {
        for (int i = 0; i < BlockGenerator.num_gens; ++i) {
            GameRegistry.addRecipe(new ItemStack(b, 1, i), "SSS", "SES", "SSS", 'S', new ItemStack(a, 1, i), 'E', ExtraUtils.transferNodeEnabled ? new ItemStack(ExtraUtils.transferNode, 1, 13) : Blocks.redstone_block);
        }
    }

    public static void addRecipes() {
        GameRegistry.addRecipe(new ItemStack(ExtraUtils.generator, 1, 0), "iii", "ItI", "rfr", 'i', Blocks.cobblestone, 'I', Items.iron_ingot, 'f', Blocks.furnace, 'r', Items.redstone, 't', Blocks.piston);
        GameRegistry.addRecipe(new ItemStack(ExtraUtils.generator, 1, 5), "iii", "iIi", "rfr", 'i', Items.iron_ingot, 'I', new ItemStack(ExtraUtils.generator, 1, 0), 'f', Blocks.furnace, 'r', Items.redstone);
        GameRegistry.addRecipe(new ItemStack(ExtraUtils.generator, 1, 1), "iii", "iIi", "rfr", 'i', Items.iron_ingot, 'I', Blocks.iron_block, 'f', Blocks.furnace, 'r', Items.redstone);
        GameRegistry.addRecipe(new ItemStack(ExtraUtils.generator, 1, 2), "iii", "iIi", "rfr", 'i', Items.gold_ingot, 'I', Blocks.iron_block, 'f', Blocks.furnace, 'r', Items.redstone);
        GameRegistry.addRecipe(new ItemStack(ExtraUtils.generator, 1, 3), "eee", "iIi", "rfr", 'e', Items.ender_pearl, 'i', Items.ender_eye, 'I', Blocks.iron_block, 'f', Blocks.furnace, 'r', Items.redstone);
        GameRegistry.addRecipe(new ItemStack(ExtraUtils.generator, 1, 4), "iii", "iIi", "rfr", 'i', Blocks.redstone_block, 'I', new ItemStack(ExtraUtils.generator, 1, 2), 'f', Blocks.furnace, 'r', Items.redstone);
        GameRegistry.addRecipe(new ItemStack(ExtraUtils.generator, 1, 6), "iii", "iIi", "rfr", 'i', Blocks.obsidian, 'I', Blocks.enchanting_table, 'f', Blocks.furnace, 'r', Items.redstone);
        GameRegistry.addRecipe(new ItemStack(ExtraUtils.generator, 1, 7), "lql", "qIq", "rfr", 'q', Items.quartz, 'l', new ItemStack(Items.dye, 1, 4), 'I', Blocks.diamond_block, 'f', Blocks.furnace, 'r', Items.redstone);
        GameRegistry.addRecipe(new ItemStack(ExtraUtils.generator, 1, 8), "iii", "iIi", "rfr", 'i', Blocks.tnt, 'I', Blocks.iron_block, 'f', Blocks.furnace, 'r', Items.redstone);
        GameRegistry.addRecipe(new ItemStack(ExtraUtils.generator, 1, 9), "iii", "iIi", "rfr", 'i', new ItemStack(Blocks.wool, 1, 6), 'I', new ItemStack(ExtraUtils.generator, 1, 0), 'f', Blocks.furnace, 'r', Items.redstone);
        GameRegistry.addRecipe(new ItemStack(ExtraUtils.generator, 1, 10), "iii", "iIi", "rfr", 'i', Items.iron_ingot, 'I', new ItemStack(ExtraUtils.generator, 1, 1), 'f', Blocks.furnace, 'r', Items.redstone);
        GameRegistry.addRecipe(new ItemStack(ExtraUtils.generator, 1, 11), "wiw", "wIw", "rfr", 'w', new ItemStack(Items.skull, 1, 1), 'i', Items.nether_star, 'I', ExtraUtils.decorative1Enabled ? new ItemStack(ExtraUtils.decorative1, 1, 5) : Blocks.iron_block, 'f', Blocks.furnace, 'r', Items.redstone);
    }
    ...
    public TileEntity createTileEntity(final World world, final int metadata) {
        try {
            return BlockGenerator.tiles[metadata].newInstance();
        } catch (Exception e) {
            e.printStackTrace();
    ...
    public ArrayList<ItemStack> getDrops(final World world, final int x, final int y, final int z, final int metadata, final int fortune) {
        ...
        final ItemStack item = new ItemStack(this, 1, this.damageDropped(metadata));
            ...
            for (int i = 0; i < tile.getSizeInventory(); ++i) {
                ...
                if (itemstack != null) {
                    ...
                    while (itemstack.stackSize > 0) {
                        ...
                        final EntityItem entityitem = new EntityItem(world, x + f, y + f2, z + f3, new ItemStack(itemstack.getItem(), k1, itemstack.getItemDamage()));
