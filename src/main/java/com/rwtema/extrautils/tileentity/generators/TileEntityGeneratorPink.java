...
public class TileEntityGeneratorPink extends TileEntityGeneratorFurnace {
    ...
    public static boolean isPinkItem(final Object item) {
        if (item instanceof ItemStack) {
            ...
            return p.getItem() == Item.getItemFromBlock(Blocks.wool) && p.getItemDamage() == 6;
    ...
    public void doSpecial() {
        if (this.coolDown > 0.0 && this.rand.nextInt(40) == 0) {
            for (final Object entity : this.worldObj.getEntitiesWithinAABB(EntityAnimal.class, AxisAlignedBB.getBoundingBox(this.x(), this.y(), this.z(), this.x() + 1, this.y() + 1, this.z() + 1).expand(10.0, 10.0, 10.0))) {
                ...
                if (animal.getGrowingAge() < 0) {
                    ...
                    if (animal.worldObj.getEntitiesWithinAABB(entity.getClass(), animal.boundingBox.expand(8.0, 8.0, 8.0)).size() > 32) {
                        return;
                    }
    ...
    public boolean isPink(final ItemStack item) {
        ...
        if (TileEntityGeneratorPink.pink == null) {
            ...
            genPink();
            LogHelper.info("Pink recipes gened in " + (System.nanoTime() - t) / 1000000.0);
        }
