...
public class TileEnderCollector extends TileEntity {
    ...
    public void updateEntity() {
        ...
        if (!this.isStuffed && this.worldObj.getTotalWorldTime() % 40L == 0L) {
            ...
            final List<EntityItem> entitiesWithinAABB = (List<EntityItem>) this.worldObj.getEntitiesWithinAABB(EntityItem.class, this.bounds);
    ...
    public void writeToNBT(final NBTTagCompound tag) {
        ...
        if (this.filter != null) {
            tag.setTag("Filter", this.filter.writeToNBT(new NBTTagCompound()));
        }
    }
    ...
    public boolean onBlockActivated(final World world, final int x, final int y, final int z, final EntityPlayer player, final int side, final float hitX, final float hitY, final float hitZ) {
        ...
        PacketTempChat.sendChat(player, new ChatComponentText(String.format("Range: %s  (%s, %s, %s -> %s, %s, %s)", this.range / 2.0f, this.bounds.minX, this.bounds.minY, this.bounds.minZ, this.bounds.maxX, this.bounds.maxY, this.bounds.maxZ)));
        return true;
    }
    ...
    public void dropItem(final ItemStack itemstack) {
        ...
        while (itemstack.stackSize > 0) {
            ...
            final EntityItem entityitem = new EntityItem(this.worldObj, this.xCoord + dx, this.yCoord + dy, this.zCoord + dz, new ItemStack(itemstack.getItem(), j1, itemstack.getItemDamage()));
    ...
    public Packet getDescriptionPacket() {
        ...
        if (this.filter != null) {
            t.setTag("Filter", this.filter.writeToNBT(new NBTTagCompound()));
        }
