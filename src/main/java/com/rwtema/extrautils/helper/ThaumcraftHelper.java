...
public class ThaumcraftHelper {
    ...
    private static void registerItems_do() {
        ...
        addAspectRecipe(ExtraUtils.enderLily, Aspect.DARKNESS, 1, Items.wheat_seeds, Items.ender_pearl, Aspect.ELDRITCH, 16);
        ...
        addAspectRecipe(ExtraUtils.wateringCan, -1, new ItemStack(ExtraUtils.wateringCan, 1, 1), Aspect.WATER, 1, Aspect.LIFE, 1, Aspect.EARTH, 2);
    ...
    private static void addAspectsDivSigil() {
        ...
        for (int i = 0; i < a.size(); ++i) {
            b.add(a.get(i), ThaumcraftHelper.pi[i]);
        }
