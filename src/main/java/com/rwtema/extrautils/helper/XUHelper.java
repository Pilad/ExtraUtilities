...
public class XUHelper {
    ...
    static {
        ...
        for (final String wrenchClassName : wrenchClassNames) {
            try {
                ...
                LogHelper.fine("Detected wrench class: " + wrenchClassName);
    ...
    public static void printTimer(final String t) {
        LogHelper.debug("time:" + t + " - " + (System.nanoTime() - XUHelper.timer) / 1000000.0);
        XUHelper.timer = System.nanoTime();
    }
    ...
    public static void dropItem(final World world, final int x, final int y, final int z, final ItemStack itemstack) {
        if (itemstack != null) {
            ...
            while (itemstack.stackSize > 0) {
                ...
                final EntityItem entityitem = new EntityItem(world, x + dx, y + dy, z + dz, new ItemStack(itemstack.getItem(), k1, itemstack.getItemDamage()));
