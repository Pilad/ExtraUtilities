...
public class RenderItemGlove implements IItemRenderer {
    ...
    static {
        ...
        FMLCommonHandler.instance().bus().register(RenderItemGlove.INSTANCE);
        MinecraftForge.EVENT_BUS.register(RenderItemGlove.INSTANCE);
    ...
    public void renderItem(final IItemRenderer.ItemRenderType type, final ItemStack item, final Object... data) {
        ...
        final RenderPlayer renderplayer = (RenderPlayer) RenderManager.instance.getEntityRenderObject(player);
        final float f7 = 1.0f;
