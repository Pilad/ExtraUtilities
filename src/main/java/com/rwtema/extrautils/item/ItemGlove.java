...
public class ItemGlove extends ItemSword {
    ...
    static {
        ...
        ItemGlove.woolProtection = new RangedAttribute("extrautils.freezeProtection", 0.0, -1.7976931348623157E308, Double.MAX_VALUE);
    }
    ...
    public void attack(final PlayerInteractEvent event) {
        ...
        ((EntityPlayerMP) player).playerNetServerHandler.sendPacket(new S23PacketBlockChange(x, y, z, event.world));
    ...
    public Multimap getAttributeModifiers(final ItemStack stack) {
        ...
        multimap.put(ItemGlove.woolProtection.getAttributeUnlocalizedName(), new AttributeModifier(this.freezeUUID, "Weapon modifier", 0.001, 0));
        return multimap;
    }
