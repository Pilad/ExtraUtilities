        ...
        if (!par2World.isRemote) {
            switch (par1ItemStack.getItemDamage()) {
                ...
                case 10: {
                    ...
                    PacketTempChat.sendChat(par3EntityPlayer, new ChatComponentText("Filter Program: ").appendSibling(new ChatComponentTranslation(matcher.unlocalizedName, new Object[0])));
                    break;
                }
            }
        }
