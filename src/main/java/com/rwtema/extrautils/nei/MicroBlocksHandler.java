...
public class MicroBlocksHandler extends ShapedRecipeHandler {
    ...
    public void loadTransferRects() {
        this.transferRects.add(new TemplateRecipeHandler.RecipeTransferRect(new Rectangle(84, 23, 24, 18), "xu_microblocks_crafting"));
    }
        ...
        public void permMaterial() {
            ...
            if (MicroBlocksHandler.currentMaterials == null) {
                ...
                for (int i = 0; i < MicroMaterialRegistry.getIdMap().length; ++i) {
                    MicroBlocksHandler.currentMaterials[i] = MicroMaterialRegistry.getIdMap()[i]._1();
                }
            }
            if (MicroBlocksHandler.currentBlocks == null) {
                ...
                for (int i = 0; i < MicroMaterialRegistry.getIdMap().length; ++i) {
                    MicroBlocksHandler.currentBlocks[i] = MicroMaterialRegistry.getIdMap()[i]._2().getItem().copy();
                }
            }
