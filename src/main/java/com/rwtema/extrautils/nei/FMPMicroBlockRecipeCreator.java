        ...
        for (final int mclass : FMPMicroBlockRecipeCreator.validClasses) {
            for (final int msize : FMPMicroBlockRecipeCreator.validSizes2) {
                if (msize != 8 || mclass == 0) {
                    ...
                    final ItemStack b = MicroRecipe.getCraftingResult(FMPMicroBlockRecipeCreator.craft);
                    if (b != null) {
    ...
    public static void loadGluingRecipes(final ArrayList<ShapedRecipes> recipes) {
        ...
        for (final int mClass : FMPMicroBlockRecipeCreator.validClasses) {
            for (final int msize : FMPMicroBlockRecipeCreator.validSizes) {
                ...
                ItemStack b = MicroRecipe.getCraftingResult(FMPMicroBlockRecipeCreator.craft);
                if (b != null) {
                ...
                b = MicroRecipe.getCraftingResult(FMPMicroBlockRecipeCreator.craft);
                if (b != null) {
