...
public class FMPMicroBlocksHandler extends ShapedRecipeHandler {
    ...
    public void loadTransferRects() {
        this.transferRects.add(new TemplateRecipeHandler.RecipeTransferRect(new Rectangle(84, 23, 24, 18), "microblocks"));
    }
        ...
        public void permMaterial() {
            ...
            if (FMPMicroBlocksHandler.currentMaterials == null) {
                ...
                for (int i = 0; i < MicroMaterialRegistry.getIdMap().length; ++i) {
                    FMPMicroBlocksHandler.currentMaterials[i] = MicroMaterialRegistry.getIdMap()[i]._1();
                }
            }
            if (FMPMicroBlocksHandler.currentBlocks == null) {
                ...
                for (int i = 0; i < MicroMaterialRegistry.getIdMap().length; ++i) {
                    FMPMicroBlocksHandler.currentBlocks[i] = MicroMaterialRegistry.getIdMap()[i]._2().getItem().copy();
                }
            }
