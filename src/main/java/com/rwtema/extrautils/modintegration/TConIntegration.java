...
public class TConIntegration implements ILoading {
    ...
    public void addBedrockiumMaterial() {
        ...
        FluidType.registerFluidType(TConIntegration.bedrock.getName(), ExtraUtils.bedrockiumBlock, 0, 850, TConIntegration.bedrock, true);
        Smeltery.addMelting(new ItemStack(ExtraUtils.bedrockiumBlock, 1), ExtraUtils.bedrockiumBlock, 0, 850, new FluidStack(TConIntegration.bedrock, 1296));
        Smeltery.addMelting(new ItemStack(ExtraUtils.bedrockium, 1, 0), ExtraUtils.bedrockiumBlock, 0, 850, new FluidStack(TConIntegration.bedrock, 144));
        final ItemStack ingotcast = new ItemStack(TinkerSmeltery.metalPattern, 1, 0);
        TConstructRegistry.getBasinCasting().addCastingRecipe(new ItemStack(ExtraUtils.bedrockiumBlock, 1), new FluidStack(TConIntegration.bedrock, 1296), null, true, 100);
        TConstructRegistry.getTableCasting().addCastingRecipe(new ItemStack(ExtraUtils.bedrockium, 1), new FluidStack(TConIntegration.bedrock, 144), ingotcast, false, 50);
        ...
        tag = new NBTTagCompound();
        tag.setInteger("MaterialId", id);
        tag.setTag("Item", new ItemStack(ExtraUtils.bedrockium, 1, 0).writeToNBT(new NBTTagCompound()));
    ...
    public void addMagicWoodMaterial() {
        ...
        FMLInterModComms.sendMessage("TConstruct", "addMaterial", tag);
        final ItemStack itemstack = new ItemStack(ExtraUtils.decorative1, 1, 8);
        tag = new NBTTagCompound();
        tag.setInteger("MaterialId", id);
    ...
    public void addUnstableMaterial() {
        ...
        FluidType.registerFluidType(TConIntegration.unstable.getName(), ExtraUtils.decorative1, 5, 850, TConIntegration.unstable, true);
        Smeltery.addMelting(new ItemStack(ExtraUtils.decorative1, 1, 5), ExtraUtils.decorative1, 5, 850, new FluidStack(TConIntegration.unstable, 648));
        Smeltery.addMelting(new ItemStack(ExtraUtils.unstableIngot, 1, 0), ExtraUtils.decorative1, 5, 850, new FluidStack(TConIntegration.unstable, 72));
        Smeltery.addMelting(new ItemStack(ExtraUtils.unstableIngot, 1, 1), ExtraUtils.decorative1, 5, 850, new FluidStack(TConIntegration.unstable, 8));
        Smeltery.addMelting(new ItemStack(ExtraUtils.unstableIngot, 1, 2), ExtraUtils.decorative1, 5, 850, new FluidStack(TConIntegration.unstable, 144));
        TConstructRegistry.getBasinCasting().addCastingRecipe(new ItemStack(ExtraUtils.decorative1, 1, 5), new FluidStack(TConIntegration.unstable, 1296), null, true, 100);
        ...
        tag = new NBTTagCompound();
        tag.setInteger("MaterialId", id);
        tag.setTag("Item", new ItemStack(ExtraUtils.unstableIngot, 1, 0).writeToNBT(new NBTTagCompound()));
        tag.setInteger("Value", 2);
        FMLInterModComms.sendMessage("TConstruct", "addMaterialItem", tag);
        tag = new NBTTagCompound();
        tag.setInteger("MaterialId", id);
        tag.setTag("Item", new ItemStack(ExtraUtils.unstableIngot, 1, 2).writeToNBT(new NBTTagCompound()));
        tag.setInteger("Value", 2);
        FMLInterModComms.sendMessage("TConstruct", "addMaterialItem", tag);
        ExtraUtilsMod.proxy.exectuteClientCode(new IClientCode() {
            @SideOnly(Side.CLIENT)
