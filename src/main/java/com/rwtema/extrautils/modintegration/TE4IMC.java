...
public class TE4IMC {
    public static void addIntegration() {
        if (ExtraUtils.decorative1 != null) {
            addTransposerFill(0, new ItemStack(Blocks.obsidian), new ItemStack(ExtraUtils.decorative1, 1, 1), createFluidTag("ender", 50), false);
        }
        if (ExtraUtils.decorative2 != null) {
            addSmelter(800, new ItemStack(Blocks.sand), new ItemStack(Blocks.glass), new ItemStack(ExtraUtils.decorative2, 2, 0));
        }
        ...
        if (ExtraUtils.decorative1 != null && FluidRegistry.getFluid("xpjuice") != null) {
            addTransposerFill(0, new ItemStack(Blocks.bookshelf, 1), new ItemStack(ExtraUtils.decorative1, 1, 8), createFluidTag("xpjuice", 8000), false);
        }
    }
    ...
    public static void addTransposerFill(int energy, final ItemStack input, final ItemStack output, final NBTTagCompound fluid, final boolean reversible) {
        ...
        tag.setInteger("energy", energy);
        tag.setTag("input", getItemStackNBT(input));
        tag.setTag("output", getItemStackNBT(output));
