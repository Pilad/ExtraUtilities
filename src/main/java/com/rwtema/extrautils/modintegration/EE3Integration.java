...
public class EE3Integration {
    ...
    public static void addEMCRecipes() {
        ...
        if (ExtraUtils.enderLilyEnabled) {
            addRecipe(new ItemStack(ExtraUtils.enderLily), new ItemStack(Items.ender_pearl, 64));
        }
        ...
        if (ExtraUtils.decorative1 != null) {
            addRecipe(new ItemStack(ExtraUtils.decorative1, 1, 8), Blocks.bookshelf, new ItemStack(Items.gold_ingot, 4), new ItemStack(Items.ender_pearl, 4));
            addRecipe(new ItemStack(ExtraUtils.decorative1, 1, 2), Blocks.quartz_block);
        }
        for (final BlockColor colorblock : ExtraUtils.colorblocks) {
            for (int i = 0; i < 16; ++i) {
                addRecipe(new ItemStack(colorblock, 1, i), colorblock.baseBlock);
            }
        }
        if (ExtraUtils.decorative2 != null) {
            addRecipe(new ItemStack(ExtraUtils.decorative2, 1, 0), Blocks.glass);
        }
