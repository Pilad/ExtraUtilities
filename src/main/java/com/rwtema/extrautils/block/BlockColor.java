...
public class BlockColor extends Block {
    ...
    public void registerBlockIcons(final IIconRegister par1IIconRegister) {
        ...
        this.blockIcon = ((TextureMap) par1IIconRegister).getTextureExtry("extrautils:bw_(" + t + ")");
    ...
    public boolean onBlockActivated(final World par1World, final int par2, final int par3, final int par4, final EntityPlayer par5EntityPlayer, final int par6, final float par7, final float par8, final float par9) {
        if (par5EntityPlayer != null && par5EntityPlayer.getCurrentEquippedItem() != null) {
            ...
            if (itemstack.getItem() instanceof ItemArmor) {
                ...
                final float p = 0.9f;
                final float[] col1 = BlockColorData.getColorData(par1World, par2, par3, par4);
                ...
                if (!par5EntityPlayer.isSneaking()) {
                    ...
                    final float[] col3 = BlockColorData.getColorData(par1World, par2, par3, par4);
    ...
    public boolean recolourBlock(final World world, final int x, final int y, final int z, final ForgeDirection side, final int colour) {
        ...
        final float p = 0.9f;
        final float[] col1 = BlockColorData.getColorData(world, x, y, z);
