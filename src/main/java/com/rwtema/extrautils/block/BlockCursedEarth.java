...
public class BlockCursedEarth extends Block implements IBlockLocalization {
    ...
    public void resetTimer(final MobSpawnerBaseLogic logic) {
        if (this.cache == null) {
            this.cache = ReflectionHelper.findMethod((Class) MobSpawnerBaseLogic.class, logic, new String[]{"resetTimer", "func_98273_j"});
        }
        try {
    ...
    public void spawnLogic(final MobSpawnerBaseLogic logic) {
        ...
        for (int i = 0; i < spawnCount; ++i) {
            ...
            final int j = logic.getSpawnerWorld().getEntitiesWithinAABB(entity.getClass(), AxisAlignedBB.getBoundingBox(logic.getSpawnerX(), logic.getSpawnerY(), logic.getSpawnerZ(), logic.getSpawnerX() + 1, logic.getSpawnerY() + 1, logic.getSpawnerZ() + 1).expand(spawnRange * 2, 4.0, spawnRange * 2)).size();
    ...
    public void updateTick(final World world, final int x, final int y, final int z, final Random rand) {
        if (!world.isRemote && world instanceof WorldServer) {
            ...
            if (blessed || world.getBlockLightValue(x, y + 1, z) < 9) {
                ...
                if (flag && isWorldGen && world.getClosestPlayer(x, y, z, 10.0) == null) {
                    flag = false;
                }
                if (flag) {
                    final int var12 = world.getEntitiesWithinAABB(EntityCreature.class, AxisAlignedBB.getBoundingBox(x, y, z, x + 1, y + 1, z + 1).expand(7.0, 2.0, 7.0)).size();
                ...
                if (flag) {
                    ...
                    if (var13 != null && !EntityFlying.class.isAssignableFrom(var13.entityClass)) {
                        ...
                        t.setLocationAndAngles(x + 0.5, y + 1, z + 0.5, rand.nextFloat() * 360.0f, 0.0f);
            ...
            if (world.getBlockLightOpacity(x, y + 1, z) > 2 || world.getBlockLightValue(x, y + 1, z) > 9) {
                ...
                for (int var15 = 0; var15 < 4; ++var15) {
                    ...
                    if ((world.getBlock(var16, var17, var18) == Blocks.dirt || world.getBlock(var16, var17, var18) == Blocks.grass) && world.getBlockLightOpacity(var16, var17 + 1, var18) <= 2 && world.getBlockLightValue(var16, var17 + 1, var18) < 9) {
                        world.setBlock(var16, var17, var18, this, world.getBlockMetadata(x, y, z), 3);
                    }
                }
            }
        }
    ...
    public void randomDisplayTick(final World par1World, final int par2, final int par3, final int par4, final Random par5Random) {
        ...
        if (par5Random.nextInt(2) == 0 && par1World.getBlockMetadata(par2, par3, par4) == 0) {
            par1World.spawnParticle("portal", par2 + par5Random.nextFloat(), par3 + 1.1f, par4 + par5Random.nextFloat(), 0.0, 0.05, 0.0);
        }
    }
