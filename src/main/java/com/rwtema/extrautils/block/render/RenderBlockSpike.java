...
public class RenderBlockSpike implements ISimpleBlockRenderingHandler {
    ...
    public boolean renderSpikeBlock(final IBlockAccess world, final int x, final int y, final int z, final int side, final int type, final Block block, final RenderBlocks renderer, final int brightness) {
        ...
        if (side != 0) {
            ...
            tessellator.addVertexWithUV(x + ax, y + ay, z + az, this.getU(0, texture, rotation, u, v), this.getV(0, texture, rotation, u, v));
            tessellator.addVertexWithUV(x + bx, y + by, z + bz, this.getU(1, texture, rotation, u, v), this.getV(1, texture, rotation, u, v));
            tessellator.addVertexWithUV(x + dx, y + dy, z + dz, this.getU(2, texture, rotation, u, v), this.getV(2, texture, rotation, u, v));
            tessellator.addVertexWithUV(x + cx, y + cy, z + cz, this.getU(3, texture, rotation, u, v), this.getV(3, texture, rotation, u, v));
        }
        if (inventory) {
            tessellator.draw();
        }
        ...
        if (side != 1) {
            ...
            tessellator.addVertexWithUV(x + ex, y + ey, z + ez, this.getU(0, texture, rotation, u, v), this.getV(0, texture, rotation, u, v));
            tessellator.addVertexWithUV(x + gx, y + gy, z + gz, this.getU(1, texture, rotation, u, v), this.getV(1, texture, rotation, u, v));
            tessellator.addVertexWithUV(x + hx, y + hy, z + hz, this.getU(2, texture, rotation, u, v), this.getV(2, texture, rotation, u, v));
            tessellator.addVertexWithUV(x + fx, y + fy, z + fz, this.getU(3, texture, rotation, u, v), this.getV(3, texture, rotation, u, v));
        }
        if (inventory) {
            tessellator.draw();
        }
        ...
        if (side != 2) {
            ...
            tessellator.addVertexWithUV(x + ax, y + ay, z + az, this.getU(0, texture, rotation, u, v), this.getV(0, texture, rotation, u, v));
            tessellator.addVertexWithUV(x + ex, y + ey, z + ez, this.getU(1, texture, rotation, u, v), this.getV(1, texture, rotation, u, v));
            tessellator.addVertexWithUV(x + fx, y + fy, z + fz, this.getU(2, texture, rotation, u, v), this.getV(2, texture, rotation, u, v));
            tessellator.addVertexWithUV(x + bx, y + by, z + bz, this.getU(3, texture, rotation, u, v), this.getV(3, texture, rotation, u, v));
        }
        if (inventory) {
            tessellator.draw();
        }
        ...
        if (side != 3) {
            ...
            tessellator.addVertexWithUV(x + dx, y + dy, z + dz, this.getU(0, texture, rotation, u, v), this.getV(0, texture, rotation, u, v));
            tessellator.addVertexWithUV(x + hx, y + hy, z + hz, this.getU(1, texture, rotation, u, v), this.getV(1, texture, rotation, u, v));
            tessellator.addVertexWithUV(x + gx, y + gy, z + gz, this.getU(2, texture, rotation, u, v), this.getV(2, texture, rotation, u, v));
            tessellator.addVertexWithUV(x + cx, y + cy, z + cz, this.getU(3, texture, rotation, u, v), this.getV(3, texture, rotation, u, v));
        }
        if (inventory) {
            tessellator.draw();
        ...
        if (side != 4) {
            ...
            tessellator.addVertexWithUV(x + cx, y + cy, z + cz, this.getU(0, texture, rotation, u, v), this.getV(0, texture, rotation, u, v));
            tessellator.addVertexWithUV(x + gx, y + gy, z + gz, this.getU(1, texture, rotation, u, v), this.getV(1, texture, rotation, u, v));
            tessellator.addVertexWithUV(x + ex, y + ey, z + ez, this.getU(2, texture, rotation, u, v), this.getV(2, texture, rotation, u, v));
            tessellator.addVertexWithUV(x + ax, y + ay, z + az, this.getU(3, texture, rotation, u, v), this.getV(3, texture, rotation, u, v));
        }
        if (inventory) {
            tessellator.draw();
        }
        ...
        if (side != 5) {
            ...
            tessellator.addVertexWithUV(x + bx, y + by, z + bz, this.getU(0, texture, rotation, u, v), this.getV(0, texture, rotation, u, v));
            tessellator.addVertexWithUV(x + fx, y + fy, z + fz, this.getU(1, texture, rotation, u, v), this.getV(1, texture, rotation, u, v));
            tessellator.addVertexWithUV(x + hx, y + hy, z + hz, this.getU(2, texture, rotation, u, v), this.getV(2, texture, rotation, u, v));
            tessellator.addVertexWithUV(x + dx, y + dy, z + dz, this.getU(3, texture, rotation, u, v), this.getV(3, texture, rotation, u, v));
        }
        if (inventory) {
            tessellator.draw();
        }
