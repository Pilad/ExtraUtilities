...
public class BlockTimer extends Block {
    ...
    public void onBlockAdded(final World world, final int x, final int y, final int z) {
        ...
        world.scheduleBlockUpdate(x, y, z, this, this.getTickRate(metadata << 1) - 2);
    }
    ...
    public void updateTick(final World world, final int x, final int y, final int z, final Random rand) {
        ...
        if (metadata == 0) {
            ...
            if (p) {
                ...
                world.scheduleBlockUpdate(x, y, z, this, this.getTickRate(metadata) - 2);
            }
        }
    }
    ...
    public void onNeighborBlockChange(final World world, final int x, final int y, final int z, final Block par5) {
        ...
        if (metadata == 0 && p) {
            ...
            world.scheduleBlockUpdate(x, y, z, this, this.getTickRate(metadata));
        }
    }
}
