...
public class RenderHandlersEndOfTime {
    ...
    public static class SkyRenderer extends IRenderHandler {
        ...
        public SkyRenderer() {
            ...
            this.field_glSkyList = ReflectionHelper.findField(RenderGlobal.class, "glSkyList", "field_72771_w");
            this.field_glSkyList2 = ReflectionHelper.findField(RenderGlobal.class, "glSkyList2", "field_72781_x");
        }
        ...
        public void render(final float p_72714_1_, final WorldClient theWorld, final Minecraft mc) {
            Label_0064:
            {
                if (mc.renderGlobal != this.renderGlobal) {
                    ...
                    final Vec3 vec3 = theWorld.getSkyColor(mc.renderViewEntity, p_72714_1_);
            ...
            final Vec3 vec4 = theWorld.getSkyColor(mc.renderViewEntity, p_72714_1_);
